...
TARGET = proto
SRCS = proto.cpp bcd.cpp addsub.cpp testbench.cpp exponent.cpp mantissa.cpp register.cpp mult.cpp div.cpp
OBJS = $(SRCS:.cpp=.o)
...
%.o: %.cpp bcd.h proto.h testbench.h exponent.h mantissa.h register.h
	$(CXX) $(CXXFLAGS) -c $< -o $@
